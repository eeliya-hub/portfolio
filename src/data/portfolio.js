    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: 'Dart', desc: 'Cross-platform UI development with Flutter.', used: 'Sky Health Project' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Flutter', desc: "Google's cross-platform mobile UI toolkit.", used: 'Sky Health Project' },
          ...
          { name: 'Firebase', desc: "Google's BaaS for auth, database, and hosting.", used: 'Sky Health Project' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Android Studio', desc: 'Official IDE for Android and Flutter development.', used: 'Sky Health Project' },
        ],
      },
      {
        ...
        items: [
          ...
          { name: 'MVVM Architecture', desc: 'Model-View-ViewModel pattern for structured apps.', used: 'Sky Health Project, Flutter builds' },
