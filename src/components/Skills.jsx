...
const skillAssetMap = {
  ...
  PHP: '/logos/PHP-logo.svg.png',
  HTML: '/logos/HTML5_logo_and_wordmark.svg.png',
  CSS: '/logos/CSS3_logo_and_wordmark.svg.png',
  React: '/logos/React-icon.svg.png',
  'Node.js': '/logos/nodejs.png',
  Django: '/logos/Django-Logo.png',
  Flutter: '/logos/flutter.png',
  SwiftUI: '/logos/swiftui-256x256_2x.png',
  'Tailwind CSS': '/logos/Tailwind_CSS_Logo.svg.png',
  Vite: '/logos/Vitejs-logo.svg.png',
  Firebase: '/logos/firebase-icon-logo-png_seeklogo-615938.png',
  'VS Code': '/logos/vscode.png',
  Git: '/logos/Git_icon.svg.png',
  GitHub: '/logos/github.png',
  Figma: '/logos/figma.png',
  Postman: '/logos/postman.png',
  'Google Cloud': '/logos/google-cloud.png',
  Xcode: '/logos/Xcode_26_icon.png',
  'Android Studio': '/logos/Android_Studio_Logo_(2023).svg.png',
};
